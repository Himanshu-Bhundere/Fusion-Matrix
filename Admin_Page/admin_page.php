...
<nav>
    ...
    <div>
      <div class="sidebar">
        ...
        <ul>
          <a href="admin_page.html"><li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
          ...
          <ul class="ecommerce">
          <a href=""><li>Revenue Collection/Distribution</li></a>
