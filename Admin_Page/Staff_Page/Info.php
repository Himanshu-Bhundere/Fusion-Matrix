...
<div class="container">
  <div class="row">
    <div class="col-12 col-sm-1 col-md-4 col-lg-3 col-xl-2">
      ...
      <p style="margin-top: 7px;"><a href="../admin_page.php">Dashboard</a>/ Staff-info</p>
    </div>
          ...
          <div class="col-12 col-sm-6 col-md-4 col-lg-4 icon">
            ...
            <ul class="employee">
                <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                  ...
                  <li class="adjust">+91 9999999999</li>
                  <br>
                  ...
                  <li class="adjust">xyz@email.address</li>
                  <br>
