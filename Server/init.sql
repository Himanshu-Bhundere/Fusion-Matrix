...
CREATE TABLE staff_details(staff_id varchar(35), s_firstname varchar(127), s_lastname varchar(127), s_age int, s_gender varchar(15), s_date_of_birth date, s_phone_no int, s_email_id varchar(127), s_aadhar_no varchar(15), s_address varchar(100));
